...
public class SecondRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        room.startScoreDecrementTimer(SecondRoomActivity.this, score, player);

        // Set up a click listener for the end game button
        endButton.setOnClickListener((View view) -> room.moveToEndScreen(SecondRoomActivity.this));

        // Set up a click listener for the next button
        nextButton.setOnClickListener((View view) ->
                room.moveToNextScreen(SecondRoomActivity.this, ThirdRoomActivity.class));
    }
}
